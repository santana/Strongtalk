...
void checkArgnPassed(int argIndex, int argValue, void** functionArray) {
  ...
  oop result = byteArrayPrimitives::alienCallResult5(arg[4], arg[3], arg[2], arg[1], arg[0], resultAlien->as_oop(),
...
TESTF(AlienIntegerCallout5Tests, alienCallResult5ShouldReturnMarkedResultForDirectAlien) {
  oop result =
    byteArrayPrimitives::alienCallResult5(smi0, smi0, smi0, smi0, smi0, resultAlien->as_oop(), resultAlien->as_oop());
...
TESTF(AlienIntegerCallout5Tests, alienCallResult5ShouldReturnMarkedResultForNullFunctionPointer) {
  oop result = byteArrayPrimitives::alienCallResult5(smi0, smi0, smi0, smi0, smi0, resultAlien->as_oop(),
