...
#define ASSERT_TRUE(condition)                                                                                         \
  {                                                                                                                    \
    if (condition) {                                                                                                   \
      ...
      addTestPartResult(new easyunit::TestPartResult(this, __FILE__, __LINE__, #condition, failure));                  \
      return;                                                                                                          \
    }                                                                                                                  \
  }
...
#define ASSERT_EQUALS(expected, actual)                                                                                \
  {                                                                                                                    \
    if (expected == actual) {                                                                                          \
      addTestPartResult(                                                                                               \
        new easyunit::TestPartResult(this, __FILE__, __LINE__, TO_STRING_EQUALS_S(#expected, #actual), success));      \
    } else {                                                                                                           \
      addTestPartResult(                                                                                               \
        new easyunit::TestPartResult(this, __FILE__, __LINE__, TO_STRING_EQUALS_F(expected, actual), failure));        \
      return;                                                                                                          \
    }                                                                                                                  \
  }
...
#define ASSERT_EQUALS_DELTA(expected, actual, delta)                                                                   \
  {                                                                                                                    \
    if (EQUALS_DELTA(expected, actual, delta)) {                                                                       \
      addTestPartResult(                                                                                               \
        new easyunit::TestPartResult(this, __FILE__, __LINE__, TO_S_E_DELTA_S(#expected, #actual, #delta), success));  \
    } else {                                                                                                           \
      addTestPartResult(                                                                                               \
        new easyunit::TestPartResult(this, __FILE__, __LINE__, TO_S_E_DELTA_F(#expected, #actual, #delta), failure));  \
      return;                                                                                                          \
    }                                                                                                                  \
  }
